...
NOTE: If you compile and run GUIController and it is a successful order it will remove from the DB. Running the unit tests immediately after may affect the success of tests so be sure to reset the state of the database by rerunning inventory.sql
